...
export default function page() {
    ...
    useEffect(() => {
        ...
        getSpecialOfferPlan({
            ...
            .then((res) => {
                if (res?.data) {
                    setOfferPlan(res.data);
                }
            })
            .catch((err) => {
                logger.error("[Campaign] Special offer fetch error:", err);
            });
    }, [isAppReady, offerPlan]);

    const specialOffer = offerPlan || AppConfig.specialOfferPlan;
