...
export default function MovieCampaignClient({ params, initialCampaign, type }: MovieCampaignClientProps) {
    ...
    // matched against the browser pathname (e.g. "/movies/dhabkaaro" or "/shows/example-show").
    ...
    // Redirect home if the path doesn't resolve to a configured campaign item
    useEffect(() => {
